view: product_development_requirements_legacy_objects_attribute_details {
  sql_table_name: dbo.Product_Development_Requirements_LegacyObjects_AttributeDetails ;;
