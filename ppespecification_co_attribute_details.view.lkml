view: ppespecification_co_attribute_details {
  sql_table_name: dbo.PPESpecification_CO_AttributeDetails ;;
  ...
  dimension: ppespecification_country {
    type: string
    sql: ${TABLE}."PPESpecification Country" ;;
  }
