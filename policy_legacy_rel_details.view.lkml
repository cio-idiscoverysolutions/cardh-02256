view: policy_legacy_rel_details {
  sql_table_name: dbo.Policy_Legacy_RelDetails ;;
  ...
  dimension: active_vault_object_name {
    ...
    html:  <a href="https://idssda.looker.com/dashboards/113?MDD%20Archive%20Number={{active_vault_object_name._value | encode_url }}" target="_new">{{value}} ;;
  }
